...
- [Обзор курса](#обзор-курса)
  ...
  - [Структура и содержание программы](#структура-и-содержание-программы)
    ...
    - [Раздел 5. Визуальные элементы графического интерфейса](#раздел-5-визуальные-элементы-графического-интерфейса)
      ...
      - [Тема 5.6. Иллюстрирование](#тема-56-иллюстрирование)
      - [Тема 5.7. Композиция](#тема-57-композиция)
...
1. Иконки и элементы в дизайне графического интерфейса приложения.
   ...
   - Практическая работа 10. Добавление иконографики в приложение.

2. Логотипы.

   - Практическая работа 11. Создание логотипа приложения (генерация и создание в векторном редакторе).

##### Тема 5.6. Иллюстрирование

1. Рисунки и иллюстрации.

##### Тема 5.7. Композиция

1. Основы композиции в дизайне. https://media.contented.ru/znaniya/instrumenty/osnovy-kompoziczii-v-dizayne/
