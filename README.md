...
- [Обзор курса](#обзор-курса)
  ...
  - [Структура и содержание программы](#структура-и-содержание-программы)
    ...
    - [Раздел 3. Создание структуры графического интерфейса](#раздел-3-создание-структуры-графического-интерфейса)
      ...
      - [Тема 3.3. Основы композиции в дизайне](#тема-33-основы-композиции-в-дизайне)
...
##### Тема 3.3. Основы композиции в дизайне

1. Сетки в дизайне графического интерфейса. История использования сеток. Виды сеток: направляющие, разметочные, модульные. Создание сеток.

2. Композиция в дизайне графического интерфейса. https://media.contented.ru/znaniya/instrumenty/osnovy-kompoziczii-v-dizayne/

   - Практическая работа 5. Разработка каркаса веб сайта (лендинг) с использованием модульных сеток.
