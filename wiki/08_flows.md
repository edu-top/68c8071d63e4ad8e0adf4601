...
- [08. Пользовательские персоны, сценарии и потоки](#08-пользовательские-персоны-сценарии-и-потоки)
  ...
  - [Практическая работа. Разработка пользовательских сценариев и потоков на основе персоны пользователя](#практическая-работа-разработка-пользовательских-сценариев-и-потоков-на-основе-персоны-пользователя)
...
### Практическая работа. Разработка пользовательских сценариев и потоков на основе персоны пользователя
