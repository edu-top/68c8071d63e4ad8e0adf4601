...
- [08. Проектирование пользовательского опыта: пользовательские персоны, сценарии и потоки](#08-проектирование-пользовательского-опыта-пользовательские-персоны-сценарии-и-потоки)
  ...
  - [Практическая работа. Разработка пользовательских сценариев и потоков на основе образа пользователя](#практическая-работа-разработка-пользовательских-сценариев-и-потоков-на-основе-образа-пользователя)
...
### Практическая работа. Разработка пользовательских сценариев и потоков на основе образа пользователя
