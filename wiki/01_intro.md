...
<dfn title="интерфейс">Интерфейс</dfn> — это общий термин, обозначающий средство или набор правил, с помощью которых происходит взаимодействие между двумя или более системами, компонентами или субъектами (агентами).
...
Таким образом, UX — это весь процесс взаимодействия пользователя с продуктом, как он его использует, насколько легко ему было достичь цели, какие эмоции он испытывает. UI — это лишь визуальная часть интерфейса, которая делает продукт привлекательным, но не гарантирует хорошего пользовательского опыта. UI является частью общего пользовательского опыта, делая его приятным и понятным.
